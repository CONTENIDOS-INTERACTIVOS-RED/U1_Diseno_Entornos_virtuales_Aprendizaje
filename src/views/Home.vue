        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda los fundamentos, beneficios y desafíos de los Entornos Virtuales de Aprendizaje (EVA), así como su diseño pedagógico e inclusivo. Se exploran modelos como ADDIE y TPACK, teorías del aprendizaje (constructivismo, conectivismo) y estrategias didácticas (ABP, gamificación, clase invertida). Además, se analizan tecnologías claves (LMS, IA, RA) y la importancia de la accesibilidad con el Diseño Universal para el Aprendizaje (DUA). Esta base permite desarrollar propuestas innovadoras que garanticen aprendizaje significativo, participación activa y equidad en la educación digital.
